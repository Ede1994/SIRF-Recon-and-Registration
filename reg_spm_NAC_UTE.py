...
# data path to UTE image
data_path_UTE_image = '/home/rich/Documents/ReCo/working_NAC2/UTE.nii'

# avoid cluttering of files, delete working-folder and start from scratch
working_folder = '/home/rich/Documents/ReCo/working_NAC2'
...
# SPM with NAC images in UTE space
...
# i = 0
# for image in sorted_alphanumeric(os.listdir(flo_path)):
#     nifty_reg = Reg.NiftyAladinSym()
#     nifty_reg.set_reference_image_filename(ref_file)
#     flo_file = flo_path + image
#     nifty_reg.add_floating_image_filename(flo_file)
#     nifty_reg.process()
#     tm_fwd = nifty_reg.get_transformation_matrix_forward()
